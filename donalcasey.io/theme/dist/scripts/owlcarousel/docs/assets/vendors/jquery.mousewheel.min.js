...
!function (a) {
  ...
  function b(b) {
    ...
    return k.settings.adjustOldDeltas && 'mousewheel' === a.type && b % 120 === 0;
      ...
      i = Array.prototype.slice;if (a.event.fixHooks) for (var j = g.length; j;) a.event.fixHooks[g[--j]] = a.event.mouseHooks;var k = a.event.special.mousewheel = { version: '3.1.11', setup: function () {
      ...
      var c = a(b)['offsetParent' in a.fn ? 'offsetParent' : 'parent']();return c.length || (c = a('body')), parseInt(c.css('fontSize'), 10);
...
//# sourceMappingURL=jquery.mousewheel.min.js.map
